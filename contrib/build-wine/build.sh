...
# on. Docker will run mapping this directory to /homedir/wine/drive_c/electronradiant
# which inside wine will look like c:\electronradiant.
...
(
    ...
    --rm \
    --workdir /homedir/wine/drive_c/electronradiant/contrib/build-wine \
    $IMGNAME \
    ./_build.sh $REV
