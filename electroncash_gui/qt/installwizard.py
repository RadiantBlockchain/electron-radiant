...
MSG_GENERATING_WAIT = _("Electron Radiant is generating your addresses, please wait...")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electron Radiant  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Electron Radiant wallet'))
    ...
    def init_network(self, network):
        message = _("Electron Radiant communicates with remote servers to get "
                    "information about your transactions and addresses. The "
                    "servers all fulfil the same purpose only differing in "
                    "hardware. In most cases you simply want to let Electron Radiant "
